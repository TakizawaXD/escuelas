...
<div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-100 p-8 animate-fade-in">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight">Crear Materia</h2>
    ...
    <form method="POST" class="space-y-6">
        ...
        <div class="pt-4 flex items-center justify-end space-x-2 border-t border-slate-100">
            ...
            <button type="submit" class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition text-sm shadow-md">Guardar Materia</button>
        </div>
    </form>
</div>
