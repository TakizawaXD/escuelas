...
<body class="bg-slate-50 flex items-center justify-center min-h-screen p-6">
    <div class="max-w-md w-full text-center space-y-6">
        <h1 class="text-9xl font-extrabold text-rose-500 tracking-widest">403</h1>
        <div class="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 space-y-4">
            <h2 class="text-2xl font-bold text-slate-800">Acceso Restringido</h2>
            <p class="text-slate-500 text-sm">No tienes los privilegios necesarios para acceder a esta sección del sistema escolar.</p>
            <div class="pt-4">
